...
Six tickets, seven live runs (VS Code 1.136.2, Copilot Chat 0.64.1, Copilot Free, auto model GPT-5.6 Luna, 1.1 credits per run); every row verified from `runs/<id>/`, never from the agent's summary.
