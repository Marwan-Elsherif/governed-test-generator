...
Feature: API GET /orders
  ...
  @status-200 @ac-2
  Scenario: returns 200 when a customer has the same order list before and after the index is added
    Given a customer has 100 orders with id "00000000-0000-4000-8000-000000000101"
    And the index on "orders.customer_id" is absent
  ...
  @status-200 @ac-3
  Scenario: returns 200 when the page is beyond the last page
